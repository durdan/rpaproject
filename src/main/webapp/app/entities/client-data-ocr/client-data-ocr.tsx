    ...
    return (
      <div>
        <h2 id="client-data-ocr-heading">
          <Translate contentKey="rpaprojectApp.clientDataOcr.home.title">Client Data Ocrs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="rpaprojectApp.clientDataOcr.home.createLabel">Create new Client Data Ocr</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('keyName')}>
                  <Translate contentKey="rpaprojectApp.clientDataOcr.keyName">Key Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('value')}>
                  <Translate contentKey="rpaprojectApp.clientDataOcr.value">Value</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('messageId')}>
                  <Translate contentKey="rpaprojectApp.clientDataOcr.messageId">Message Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={this.sort('attachmentId')}>
                  <Translate contentKey="rpaprojectApp.clientDataOcr.attachmentId">Attachment Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="rpaprojectApp.clientDataOcr.transaction">Transaction</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {clientDataOcrList.map((clientDataOcr, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{clientDataOcr.messageId}</td>
                  <td>{clientDataOcr.clientEmailAddress}</td>
                  <td>{clientDataOcr.attachmentId}</td>
                  <td>
